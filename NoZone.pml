...
proctype horizontal(){
    ...
    //::atomic{COC=1 -> H>0}
    if
    ::(atm_layer[2]==1 && climb[2]==1 && H>1600) -> (COC==1 && auto_resolver==0 && pilot_response==0)
    ::(atm_layer[2]==1 && climb[2]==1 && 1600>=H>1000) -> (COC==0 && auto_resolver==0 && pilot_response==1)
    ::(atm_layer[2]==1 && climb[2]==1 && 1000>H) -> (COC==0 && auto_resolver==1 && pilot_response==0 && climb[1]==1)
    fi
    //::(H==0)-> break;
    od
